...
\begin{figure}[htb]
    ...
    \begin{subfigure}
        \centering
        \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=3in]{./fig/clipperMCTS.png}};
            \node[] (text) at (2, 6.1) {\scriptsize Jupiter SMA};
            % \fill (text.north west) circle (0.1em);
        \end{tikzpicture}
    \end{subfigure}
...
\begin{figure}[t!]
    ...
    \begin{tikzpicture}
        ...
        \node[] at (4.8, 6.2) {\large\circled{2}};
        % NUMBER 3
